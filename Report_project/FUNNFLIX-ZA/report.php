<head>
  <title>FUNNFLIX REPORT FOR ZA PROMOTIONS</title>
  <meta charset="utf-8">
...
$sql3="SELECT DATE(date_za) as date,count(distinct msisdn) as msisdn from funnflix_mtn_status_changed where DATE(date_za) between '$from' and '$to' and status='ACTIVE' group by DATE(date_za)";
